...
class getid3_quicktime extends getid3_handler
{
	...
	public function Analyze() {
		...
		$info['quicktime']['FileController'] = 'standard'; // may be overridden if 'ctyp' atom is present
	...
	/* due to lack of known documentation, this is a kludge implementation. If you know of documentation on how mdat is properly structed, please send it to info@getid3.org */
				...
				case 'ctyp': // FileController TYPe atom (seen on QTVR)
					// http://homepages.slingshot.co.nz/~helmboy/quicktime/formats/qtm-layout.txt
					// some controller names are:
					//   0x00 + 'std' for linear movie
					//   'none' for no controls
					$atom_structure['ctyp'] = substr($atom_data, 0, 4);
					$info['quicktime']['FileController'] = $atom_structure['ctyp'];
